...
''' <summary>
''' Exception rased when an operation is disallowed due to a licensing restriction
''' </summary>
<Serializable>
Public Class LicenseRestrictionException : Inherits BluePrismException

    ''' <summary>
    ''' Creates a new exception with a standard
