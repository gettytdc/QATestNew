...
{
    internal class TreeExpandCollapseHandlerTests : UIAutomationHandlerTestBase<TreeExpandCollapseHandler>
    {
        ...
        [Test]
        public void ExecuteWithValidElementCallsExpandCollapse()
        {
        ...
        public void ExecuteFollowsMatchIndex()
        {
            ...
            FindTreeNodeMock("sameName2").Verify(m => m.GetCurrentPattern<IExpandCollapsePattern>(), Times.AtLeastOnce());
        }
        ...
        {
            return clsQuery.Parse($"UIATreeExpandCollapse IDName=\"{name}\" Position={matchIndex}");
        }
            ...
            return (mock) =>
                            {
                                ...
                                mock.Setup(m => m.GetCurrentPattern<IExpandCollapsePattern>()).Returns(GetMock<IExpandCollapsePattern>().Object);
