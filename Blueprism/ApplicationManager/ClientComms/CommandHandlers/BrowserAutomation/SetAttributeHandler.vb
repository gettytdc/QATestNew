...
Namespace CommandHandlers.BrowserAutomation
    ...
    <CommandId("WebSetAttribute")>
    Friend Class SetAttributeHandler : Inherits BrowserAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IWebElement, context As CommandContext) As Reply
            ...
            Dim value = context.Query.GetParameter(clsQuery.ParameterNames.Value)
