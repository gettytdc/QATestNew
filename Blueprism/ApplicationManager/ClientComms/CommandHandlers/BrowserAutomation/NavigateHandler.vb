...
Namespace CommandHandlers.BrowserAutomation
    ...
    <CommandId("WebNavigate")>
    Friend Class NavigateHandler : Inherits BrowserAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IWebElement, context As CommandContext) As Reply
            element.Page.NavigateTo(context.Query.GetParameter(clsQuery.ParameterNames.NewText))
            Return Reply.Ok
        End Function
