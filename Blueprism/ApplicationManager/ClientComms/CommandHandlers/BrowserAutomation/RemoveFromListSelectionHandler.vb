...
Namespace CommandHandlers.BrowserAutomation
    ...
    <CommandId("WebRemoveFromListSelection")>
    Friend Class RemoveFromListSelectionHandler : Inherits BrowserAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IWebElement, context As CommandContext) As Reply
            ...
            element.RemoveFromListSelection(index, name)
