...
Namespace BluePrism.ApplicationManager.AMI
    ...
    ''' <summary>
    ''' Exception indicating that AMI is not connected to an application when it was
    ''' asked to perform an application-based operation
    ''' </summary>
    <Serializable>
    Public Class NotConnectedException : Inherits BluePrismException

        ''' <summary>
        ''' Creates a new exception with a default message
        ''' </summary>
        Public Sub New()
            MyBase.New(NotConnected)
        End Sub
