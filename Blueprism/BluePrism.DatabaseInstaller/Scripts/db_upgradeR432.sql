...
BEGIN
	...
	ORDER BY rd.VirtualWorkerName,rd.Dates
	offset (@pagenumber - 1) * @lpagesize rows
...
('432', 
 GETUTCDATE(), 
 'db_upgradeR432.sql', 
 'Amende BPDS_Get_Process_History_Per_Worker_Parameterised_Query stored procedure', 
 0
);
