...
#Region " Windows Form Designer generated code "
    ...
    Private ReadOnly mStartUpOptions As ResourcePCStartUpOptions
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmResourcePC))
...
#End Region
    ...
    Public Sub New(startUpOptions As ResourcePCStartUpOptions)
        ...
        Dim porttxt = If(mStartupOptions.SSLCertHash IsNot Nothing,
                         String.Format(My.Resources.Port0Secured, mStartupOptions.Port),
                         String.Format(My.Resources.Port0, mStartupOptions.Port))
        lblPort.Text = porttxt

        Dim version = Me.GetBluePrismVersion(fieldCount:=3)
        Me.Text = String.Format(My.Resources.BluePrismResourcePCPort0Version1, mStartUpOptions.Port, version)
    ...
    Public Sub DisplayRestarting() Implements IResourcePCView.DisplayRestarting
        ...
        If Not Visible Then
            With iconNotify
                ...
                .BalloonTipText = String.Format(My.Resources.AutomatesResourcePcHasBeenRestartedOnPort0, mStartUpOptions.Port)
