...
Namespace Commands
    ...
    Public Class ControllerCommand
        ...
        Public Overrides ReadOnly Property Help() As String
            Get
                Return My.Resources.ControllerCommand_SignifiesThatThisIsAConnectionFromTheControllerOfAPoolThisCommandIsUsedInternal
            End Get
        End Property
        ...
        Protected Overrides Function Exec(command As String) As String
            ...
            If command.Length <= 11 Then Return "MISSING PARAMETER"
            Dim poolID As Guid = GetNearestPoolID(command.Substring(11))
            If poolID = Nothing Then Return "NOT VALID"

            If Listener.IsController Then Return "NO, *I* AM A CONTROLLER"

            If Listener.PoolId <> poolID Then Return "BAD ID"

            Client.IsControllerConnection = True
            Return "OK"
        End Function
