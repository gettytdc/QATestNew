...
SCRIPT         : 204
AUTHOR         : SW
PURPOSE        : Updates "get next" call to retry on collision
RELATED BUG    : 9552
*/

-- Implement a 'rethrow' procedure for rethrowing an error from a CATCH block
-- This is largely lifted from the SQL Server help - "Using TRY...CATCH in Transact-SQL"
if not exists (select * from sys.procedures where name='usp_rethrow' and type='P')
  exec(N'create procedure usp_rethrow as select 1');
GO
...
alter procedure usp_rethrow as
...
INSERT INTO BPADBVersion VALUES (
  '204',
  GETUTCDATE(),
  'db_upgradeR204.sql UTC',
  'Updates "get next" call to retry on collision'
);
