...
Namespace CommandHandlers.UIAutomation
    ...
    <Command("Removes the given item from the tree's selected items.")>
    <Parameters("Those required to uniquely identify the element, plus 'IDName' identifying the item to remove")>
    <CommandId("UIATreeRemoveFromSelection")>
    Friend Class TreeRemoveFromSelectionHandler : Inherits UIAutomationHandlerBase
