...
Namespace CommandHandlers.BrowserAutomation
    ...
    <CommandId("WebUpdateCookie")>
    Friend Class UpdateCookieHandler : Inherits BrowserAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IWebElement, context As CommandContext) As Reply
            ...
            Dim cookie = context.Query.GetParameter(clsQuery.ParameterNames.NewText)

            element.Page.UpdateCookie(cookie)
