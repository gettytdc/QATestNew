...
Namespace CommandHandlers.BrowserAutomation
    ...
    <CommandId("WebSelectTextRange")>
    Friend Class SelectTextRange : Inherits BrowserAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IWebElement, context As CommandContext) As Reply
            ...
            Dim startIndex = context.Query.GetIntParam(clsQuery.ParameterNames.Index)
            Dim length = context.Query.GetIntParam(clsQuery.ParameterNames.Length)
            element.SelectTextRange(startIndex, length)
