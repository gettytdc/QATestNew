...
''' <summary>
''' Exception indicating that no AA elements were found that matched a given query.
''' </summary>
<Serializable>
Public Class NoSuchUIAutomationElementException : Inherits NoSuchElementException
    ...
    Public Sub New()
        MyBase.New(
         My.Resources.UnableToMatchAnyUIAutomationElementsToTheSuppliedQueryTerms)
    End Sub
