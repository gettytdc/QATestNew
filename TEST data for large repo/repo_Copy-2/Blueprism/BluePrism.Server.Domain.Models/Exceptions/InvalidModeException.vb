...
''' <summary>
''' Exception indicating that a certain mode of something was required for some
''' operation and that the specified mode was not recognised or available
''' </summary>
<Serializable()> _
Public Class InvalidModeException : Inherits InvalidTypeException
