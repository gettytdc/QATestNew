...
''' <summary>
''' Exception indicating that a given value was invalid for some reason
''' </summary>
<Serializable()> _
Public Class InvalidValueException : Inherits BluePrismException
    ...
    ''' </summary>
    ''' <param name="msg">The message with the detail for this exception.</param>
    ...
    Public Sub New(cause As Exception, ByVal msg As String)
