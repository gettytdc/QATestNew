...
{
    internal class ScrollVerticalHandlerTests : UIAutomationHandlerTestBase<ScrollVerticalHandler>
    {
        ...
        public void Execute_WithParameters_ShouldScroll(bool scrollUp, bool bigStep, ScrollAmount expectedAmount)
        {
            ...
            string query = $"UIAScrollVertical scrollup={scrollUp} bigstep={bigStep}";
            Execute(clsQuery.Parse(query));
            patternMock.Verify(p => p.Scroll(ScrollAmount.NoAmount, expectedAmount));
        }
