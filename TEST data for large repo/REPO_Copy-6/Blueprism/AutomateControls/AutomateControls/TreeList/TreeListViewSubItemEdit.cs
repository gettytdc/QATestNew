...
namespace AutomateControls.TreeList
{
    internal class CustomEdit : NativeWindow, IWin32Window
    {
        ...
        public void ShowEditControl()
        {
            ...
            ListViewItem item = (System.Windows.Forms.ListViewItem) _treelistview.EditedItem.Item;
            Rectangle rec = _treelistview.EditedItem.ColumnIndex > 0 ?
                ...
                _treelistview.GetItemRect(item.Index, System.Windows.Forms.ItemBoundsPortion.Label);
    ...
    internal class TreeListViewItemEditControlHandle : NativeWindow, IWin32Window
    {
        ...
        private bool OnKillFocus(Message m)
        {
            ...
            if(!(_control is System.Windows.Forms.ComboBox)) return true;
        ...
        protected override void WndProc(ref Message m)
        {
            switch(m.Msg)
            {
                ...
                case (int) APIsEnums.WindowMessages.KILLFOCUS:
                    if(OnKillFocus(m))
                    {
                        EndEdit(!(_control is System.Windows.Forms.ComboBox && _treelistview.EditedItem.Label != _control.Text));
                        return;
                    }
                    break;
            }
