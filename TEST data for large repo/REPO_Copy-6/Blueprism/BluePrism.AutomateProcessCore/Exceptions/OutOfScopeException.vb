...
''' <summary>
''' Exception thrown when a stage references the data stage which is beyond the
''' scope of the stage referencing it.
''' </summary>
<Serializable>
Public Class OutOfScopeException : Inherits InvalidStateException
