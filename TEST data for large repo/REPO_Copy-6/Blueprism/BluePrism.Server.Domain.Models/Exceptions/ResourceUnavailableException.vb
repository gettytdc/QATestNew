...
''' <summary>
''' Exception raised if a required resource was unavailable
''' </summary>
<Serializable()> _
Public Class ResourceUnavailableException : Inherits UnavailableException

    ''' <summary>
    ''' Creates a new exception with no message
    ''' </summary>
    Public Sub New()
        MyBase.New(My.Resources.ResourceUnavailableException_ARequiredResourceWasUnavailable)
    End Sub
