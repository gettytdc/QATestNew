...
''' <summary>
''' Exception indicating that no HTML elements were found that matched a given query.
''' </summary>
<Serializable>
Public Class NoSuchHTMLElementException : Inherits NoSuchElementException

    ''' <summary>
    ''' Creates a new exception with a default message
    ''' </summary>
    Public Sub New()
        MyBase.New(My.Resources.NoElementsMatchTheSuppliedQueryTerms)
    End Sub
