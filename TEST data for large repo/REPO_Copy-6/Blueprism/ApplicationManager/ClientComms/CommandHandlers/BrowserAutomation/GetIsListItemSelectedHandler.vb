...
Namespace CommandHandlers.BrowserAutomation
    ...
    <CommandId("WebGetIsSelected")>
    Friend Class GetIsListItemSelectedHandler : Inherits BrowserAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IWebElement, context As CommandContext) As Reply
            ...
            Return Reply.Result(element.GetIsListItemSelected())
