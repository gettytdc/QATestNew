...
Namespace CommandHandlers.BrowserAutomation
    ...
    <CommandId("WebGetHTMLSource")>
    Friend Class GetHtmlSourceHandler : Inherits BrowserAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IWebElement, context As CommandContext) As Reply
            Return element.Page.GetHTMLSource().Map(AddressOf Reply.Result)
        End Function
    End Class
End Namespace
