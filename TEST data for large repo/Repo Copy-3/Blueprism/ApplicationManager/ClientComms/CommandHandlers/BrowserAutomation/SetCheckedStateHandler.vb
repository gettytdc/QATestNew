...
Namespace CommandHandlers.BrowserAutomation
    ...
    <CommandId("WebSetCheckState")>
    Friend Class SetCheckedStateHandler : Inherits BrowserAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IWebElement, context As CommandContext) As Reply
            ...
            Dim value = context.Query.GetBoolParam(clsQuery.ParameterNames.NewText)
            element.SetCheckedState(value)
