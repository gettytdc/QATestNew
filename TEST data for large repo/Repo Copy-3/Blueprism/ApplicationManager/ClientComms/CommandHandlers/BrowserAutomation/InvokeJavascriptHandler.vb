...
Namespace CommandHandlers.BrowserAutomation
    ...
    <CommandId("WebInvokeJavascript")>
    Friend Class InvokeJavascriptHandler : Inherits BrowserAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IWebElement, context As CommandContext) As Reply
            ...
            Dim functionName = context.Query.GetParameter(clsQuery.ParameterNames.MethodName)
            Dim parameters = context.Query.GetParameter(clsQuery.ParameterNames.Arguments)
            
            element.Page.InvokeJavascript(functionName, parameters)
