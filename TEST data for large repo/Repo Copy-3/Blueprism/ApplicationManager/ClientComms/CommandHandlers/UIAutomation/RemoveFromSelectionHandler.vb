...
Namespace CommandHandlers.UIAutomation
    ...
    ''' </summary>
    <CommandId("UIARemoveFromSelection")>
    Friend Class RemoveFromSelectionHandler : Inherits UIAutomationHandlerBase

        ''' <summary>
        ''' Initializes a new instance of the <see cref="RemoveFromSelectionHandler" /> class.
        ''' </summary>
