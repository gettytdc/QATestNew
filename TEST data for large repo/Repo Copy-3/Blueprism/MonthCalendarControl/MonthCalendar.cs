namespace CustomControls
{
   ...
   public class MonthCalendar : Control
   {
      ...
      [System.Diagnostics.CodeAnalysis.SuppressMessage("Critical Bug",
          "S4275:Getters and setters should access the expected fields", Justification = "viewStart is set within the SetStartDate() Method")]
      ...
      public MonthCalendarHitTest HitTest(Point location)
      {
        ...
        /// <summary>
        /// SetDate helper method to set the calendar to the specified date
        /// </summary>
