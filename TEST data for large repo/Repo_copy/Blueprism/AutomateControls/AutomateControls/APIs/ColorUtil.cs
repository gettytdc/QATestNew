    ...
    internal class ColorUtil
    {
        ...
        static internal Color ColorFromRGBString(string text)
        {
            ...
            if ( RGBs.Length != 3 ) 
            {
                ...
                throw new ArgumentException("RGB color string is not well formed");
            }
            ...
            try 
            {
                ...
                {
                    throw new ArgumentException("Out of bounds RGB value");
                }
                else 
                {
                    // Convert to color 
            ...
            {
                throw new InvalidCastException("Invalid RGB value");
            }
        ...
        static internal uint RGB(Color c)
        {
