...
Namespace CommandHandlers.UIAutomation
    ...
    Friend Class DragHandler : Inherits UIAutomationHandlerBase
        ...
        Protected Overrides Function Execute(element As IAutomationElement, context As CommandContext) As Reply
            ...
            mMouseOperationsProvider.DragFrom(absoluteX, absoluteY)
