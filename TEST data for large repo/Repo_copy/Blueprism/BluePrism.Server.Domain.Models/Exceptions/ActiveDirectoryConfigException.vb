...
''' <summary>
''' Exception indicating that an error has occurred in the Active Directory
''' configuration.
''' </summary>
<Serializable()>
Public Class ActiveDirectoryConfigException : Inherits ConfigurationException
    ...
    ''' in the <see cref="Microsoft.SqlServer.Server.Format"/> method.</param>
