...
''' <summary>
''' Exception thrown when a resource specified by an ID/name does not exist.
''' </summary>
<Serializable()> _
Public Class NoSuchResourceException : Inherits NoSuchElementException
    ''' <summary>
    ''' Creates a new exception with no message
    ''' </summary>
    Public Sub New()
        Me.New(My.Resources.NoSuchResourceException_ResourcePCNotFound)
    End Sub
