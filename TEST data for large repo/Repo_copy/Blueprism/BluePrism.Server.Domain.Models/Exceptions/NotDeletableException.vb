...
''' <summary>
''' Exception indicating that an object or value is not deletable, but an attempt
''' was made to delete it.
''' </summary>
<Serializable()> _
Public Class NotDeletableException : Inherits BluePrismException
