...
''' <summary>
''' Exception indicating that something has expired, meaning that it is not in a
''' valid state to operate on.
''' </summary>
<Serializable()> _
Public Class ExpiredException : Inherits InvalidStateException
