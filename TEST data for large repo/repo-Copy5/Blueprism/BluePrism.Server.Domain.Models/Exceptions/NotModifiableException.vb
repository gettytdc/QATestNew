...
''' <summary>
''' Exception indicating that an object or value is not modifiable, but an attempt
''' was made to modify it.
''' </summary>
<Serializable()> _
Public Class NotModifiableException : Inherits BluePrismException
