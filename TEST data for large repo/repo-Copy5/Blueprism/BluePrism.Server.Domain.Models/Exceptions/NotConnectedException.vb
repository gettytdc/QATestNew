...
''' <summary>
''' Exception thrown when a resource is not in a connected state when it should be.
''' </summary>
<Serializable()> _
Public Class NotConnectedException : Inherits InvalidStateException

    ''' <summary>
    ''' Creates a new exception with no message
    ''' </summary>
    Public Sub New()
        Me.New(My.Resources.NotConnectedException_NoConnectionToResourcePC)
    End Sub
