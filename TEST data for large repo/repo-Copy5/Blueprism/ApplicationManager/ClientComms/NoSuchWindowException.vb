...
''' <summary>
''' Exception indicating that no windows were found that matched a given query.
''' </summary>
<Serializable>
Public Class NoSuchWindowException : Inherits NoSuchElementException

    ''' <summary>
    ''' Creates a new exception with a default message
    ''' </summary>
    Public Sub New()
        MyBase.New(My.Resources.UnableToMatchAnyWindowsWithTheQueryTerms)
    End Sub
